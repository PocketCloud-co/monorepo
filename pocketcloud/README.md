...
| **Device Runtime** | [`docs/DEVICE-RUNTIME.md`](docs/DEVICE-RUNTIME.md) — the runc answer, honest device-class supply matrix, tiered fleet architecture (M/D/H), artifact delivery, resource-cap spec |
