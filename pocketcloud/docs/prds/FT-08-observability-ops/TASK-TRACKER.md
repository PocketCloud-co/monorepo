...
| OO-007 | P0 | Chaos scenario suite | PF-011 | churn storm, partition, slow-host, relay-loss scenarios nightly; SLO regression blocks release (gate in FT-00); audit/security events provably survive drop-oldest telemetry backpressure (SEC-001 gap 10) | Proposed | |
