...
|----|---|-------|-----------|---------------------|--------|-----------|
| PF-001 | P0 | CI workflow: PoC suite on every PR | — | `.github/workflows/pocketcloud-ci.yml` runs syntax check, full test suite, demo smoke on PRs touching `pocketcloud/`; red suite blocks merge | Done (2026-07-04) | workflow live; green check runs on PR #1 |
...
| PF-013 | P0 | Tracking hierarchy completion (project + milestone trackers, integration specs) | — | PROJECT-TRACKER.md + milestones/M0..M5 + specs/SPEC-001..007 exist; CI verifies structure; feature trackers remain the task source of truth | Done (2026-07-05) | docs/PROJECT-TRACKER.md, docs/milestones/, docs/specs/; CI hierarchy check |
| PF-014 | P0 | Independent best-practices review gate (Standards §9) + first full-stack review | PF-013 | §9 checklist codified; review-report convention (`docs/reviews/`); first full-stack review executed with all findings dispositioned as tracker rows or waivers | Done (2026-07-05) | Standards §9; docs/reviews/2026-07-05-full-stack-M0.md |
